...
Usa pseudocódigo al principio si eso te ayuda. Recuerda que la máquina necesita que le indiquemos en detalle cada pequeño pasito que debe dar, así que así debes escribirlo en tu pseudocódigo. 
Ejemplo:*/
function orderNumbers(numbers, o) {
    var result = [];

    /* Si el orden en el que hay que ordenar los números (parámetro o) es 'ascendente', la función usará un método para ordenar números (seguramente JavaScript tenga uno ya "prefabricado"). Tendrá que aplicarse ese método al array numbers y asignarse el resultado de esa operación a la variable result.
