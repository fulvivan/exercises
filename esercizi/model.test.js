...
var res = orderNumbers([4, 2, 5, 1, 8], 'asc') // [1, 2, 4, 5, 8]
...
var res = orderNumbers([4, 2, 5, 1], 'ascendente') // 'Enter "asc" or "desc" as the order parameter' // [4, 2, 5, 1]
